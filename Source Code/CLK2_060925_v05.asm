...
;	CLK2 T<CR>	will copy the Clock time and date to the system
;			time and date
...
;   'Copyright (C) 2025 by Ruud Broers'
;   'Model II support, fix crash on illegal date or day'
...
SETTIM
;	Register	Contents
;	0		FRACTION	0.1sec	0.01sec
;	1		SECONDS		0 10sec	seconds
;	2		MINUTES		0 10min	minutes
;	3		HOUR		12/24 0 10/AP	HR  HOURS
;	4		OSC RST DAY	0 0 OSC RST 0 DAY
;	5		DATEDAY		0 0 10DATE DATE
;	6		MONTH		0 0 10MONTH MONTH
;	7		YEAR		10YEAR YEAR
